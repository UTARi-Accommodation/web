    ...
    return (
        <Container>
            <Title
                ...
                content="The privacy and policy of UTARi"
            />
            <Content>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> (referred to as either
                            &quot;the Website&quot;, &quot;We&quot;,
                    ...
                    <li>
                        <p>
                            ...
                            the Website. It refers to third-party companies or
                            individuals employed by the Website to facilitate
                            the Service, to provide the Service on behalf of the
                            Website, to perform services related to the Service
                            or to assist the Website in analyzing how the
                            Service is used.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            ...
                            or using the Service, or the website, or other legal
                ...
                <p>
                    ...
                    You visit, the time and date of Your visit, unique device
                ...
                <p>
                    The Website allows You to create an account and log in to
                ...
                <p>
                    A UTARi account must have <strong>ONE</strong> unique email
                    address only. Therefore, you cannot create multiple UTARi
                    accounts through multiple Social Media Services accounts
                    that use the same email. Instead, all social media accounts
                    with the same email will login to the same UTARi account.
                </p>
                <p>
                ...
                <p>
                    ...
                    information with the Website through Your Third-Party Social
                    Media Service&apos;s account. If You choose to provide such
                    information and Personal Data, during registration or
                    otherwise, You are giving the Website permission to use,
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Website, for example, to count users who have visited
                ...
                <p>
                    The Website may use Personal Data for the following
                    purposes:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p>
                            ...
                            analysis, identifying usage trends and to evaluate
                ...
                <p>
                    Your personal information will never be made available to
                    any services or third-parties other than UTARi and your
                    choice of Social Media Service except in the following
                    situations:
                </p>
                <ul>
                    <li>
                ...
                <p>
                    The Website will retain Your Personal Data only for as long
                ...
                <p>
                    The Website will also retain Usage Data for internal
                ...
                <p>
                    Under certain circumstances, the Website may be required to
