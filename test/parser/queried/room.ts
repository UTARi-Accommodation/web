...
const testRoomsQueriedParser = () =>
    describe('All Room Information Queried Parser', () => {
        ...
        it('should failed to parse the rooms queried fields correctly as some required fields are total page is missing', () => {
            const data = {
                rooms: [
                    {
                        id: 45,
            ...
            expect(() => parseAsRoomsQueried(data)).toThrowError();
        });
    });

export default testRoomsQueriedParser;
